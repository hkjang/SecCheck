...
var notificationEvents = []map[string]string{
	...
	{"code": "APPROVAL_WITHDRAWN", "label": "결재 요청 회수", "description": "요청된 최종 승인이 검토자에 의해 회수되었을 때 (승인자)"},
	...
	{"code": "API_KEY_REVOKED", "label": "API 키 폐기", "description": "관리자가 내 API 키를 폐기했을 때"},
	{"code": "ACCOUNT_LOCKED", "label": "권한 계정 자동 잠금", "description": "권한 계정이 장기 미접속으로 잠겼을 때 (시스템 관리자)"},
	{"code": "EVIDENCE_UNREADABLE", "label": "증적 무결성 확인 실패", "description": "저장된 증적이 사라졌거나 기록과 다를 때 (시스템 관리자)"},
