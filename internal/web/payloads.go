...
var requestPayloads = map[string][]payloadField{
	...
	"POST /api/v1/review-requests/{id}/transfer-requester":                  {{"requester_id", "string"}},
	...
	"POST /api/v1/admin/settings/mail/test":                                 {{"recipient", "string"}},
	...
	"POST /api/v1/admin/analytics/allow":                                    {{"origin", "string"}},
	...
	"POST /api/v1/review-requests/{id}/items/{itemID}/evidences/carry-over": {{"evidence_ids", "[]string"}},
...
var objectScopedRoutes = map[string]bool{
	...
	"POST /api/v1/review-requests/{id}/transfer-requester":                  true,
	"GET /api/v1/review-requests/{id}/items/{itemID}/verdict-history":       true,
	...
	"GET /api/v1/review-requests/{id}/items/{itemID}/evidences/carry-over":  true,
	"GET /api/v1/review-requests/{id}/items/{itemID}/why":                   true,
	"GET /api/v1/review-requests/{id}/approval-brief":                       true,
	"GET /api/v1/review-requests/{id}/service-history":                      true,
	"POST /api/v1/review-requests/{id}/items/{itemID}/evidences/carry-over": true,
