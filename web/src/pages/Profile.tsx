...
function PasswordCard() {
  ...
  const submit = async (e: FormEvent) => {
    e.preventDefault()
    setBusy(true)
    try { await put('/api/v1/me/password', { current_password: form.current_password, new_password: form.new_password }); setForm({ current_password: '', new_password: '', confirm: '' }); toast.push('비밀번호를 변경했습니다. 다른 기기의 로그인 세션은 모두 종료되었습니다.') }
