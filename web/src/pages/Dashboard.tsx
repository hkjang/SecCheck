...
type DashboardData = { status_counts: Record<string, number>; opening_soon: number; open_change_requests: number; my_queue: QueueEntry[]; due_soon: DueChange[]; my_follow_ups?: FollowUp[] }
