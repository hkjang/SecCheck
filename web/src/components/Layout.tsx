...
import { Activity, Bell, BookOpen, Boxes, CheckSquare, ChevronDown, ClipboardCheck, FileKey, Gauge, History, KeyRound, LayoutDashboard, ListChecks, Lock, Logs, Search, Settings, Shield, ShieldCheck, Sparkles, Users, X } from 'lucide-react'
