...
const navigation: Nav[] = [
  ...
  { to: '/admin/api-keys', label: 'API 키', icon: FileKey, roles: ['SYSTEM_ADMIN'] },
  { to: '/admin/system', label: '시스템 정보', icon: Cpu, roles: ['SYSTEM_ADMIN'] },
...
export default function Layout() {
  ...
  const [results, setResults] = useState<{ reviews?: Record<string, string>[]; items?: Record<string, string>[]; evidences?: Record<string, string>[]; has_more?: Record<string, boolean> }>({})
