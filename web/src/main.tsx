...
function App() {
  ...
  if (me.totp_enrollment_required) {
    return <AuthContext.Provider value={{ user: me.user, version: me.version, refresh, logout, enrolling: true }}><Routes><Route element={<Layout />}><Route path="*" element={<SecurityPage />} /></Route></Routes></AuthContext.Provider>
  }
